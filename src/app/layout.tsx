...
export const metadata: Metadata = {
  title: "Fresh Fund - Tel-Aviv VC Investing in Israeli Innovation",
  description: "Fresh Fund is a Tel-Aviv based venture capital firm investing in seed and Series A companies in enterprise software, fintech, AI, and cybersecurity. We back exceptional founders building global companies.",
  keywords: "venture capital, VC, Israel, Tel-Aviv, startup investment, enterprise software, fintech, AI, cybersecurity, seed funding",
  openGraph: {
    title: "Fresh Fund - Israeli Venture Capital",
    description: "Invest in the future with Fresh Fund. We back exceptional founders in enterprise software, fintech, AI, and cybersecurity.",
    siteName: "Fresh Fund",
    type: "website"
  },
  robots: {
